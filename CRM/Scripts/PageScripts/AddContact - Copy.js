...
//    var obj = {};
//    $.ajax({
//        url: "/Contact/Contact/GetDetails",
//        contentType: "application/json; charset=utf-8",
//        dataType: "json",
//        data: JSON.stringify({ "data": JSON.stringify(obj) }),
//        type: "Get",
...
//        thead += "<th class='sorting_asc' tabindex='0' aria-controls='tblContactData' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Contact : activate to sort column descending'> Contact Name</th>";
...
//            row += "<tr role='row'>";
//            row += "<td class='sorting_1' id='ContactId" + result[i].Contact_Id + "' style='display:none'>" + result[i].Contact_Id + "</td>";
//            row += "<td>" + (parseInt(i) + parseInt(1)) + "</td>";
//            row += "<td>" + result[i].Contact_Name + "</td>";
...
//            row += "<td><a onclick=EditContact(" + result[i].Contact_Id + ")><i class='fas fa-edit' style='font-size:20px;color:blue'></i></a> &nbsp;<a onclick=DeleteContact(" + result[i].Contact_Id + ")><i class='far fa-trash-alt' style='font-size:20px;color:red'></i></a></td>";
